...
class ParallelDistilledPipeline:
    ...
    def __init__(
        ...
        if os.getenv("LTX_ENABLE_RESIDENT_AUDIO", "0") == "1":
    ...
    def _fix_audio_vocoder_dtype(self) -> None:
        ...
        if self.ctx.device_type == "npu":
            ...
            if enable_audio and is_main_rank:
    ...
    def _hook_resident_audio(self) -> None:
        ...
        Env:
          ...
          LTX_AUDIO_DISABLE_BWE=1  # recommended
        """
        import os
        import time
        import torch
        ...
        disable_bwe = os.getenv("LTX_AUDIO_DISABLE_BWE", "1") == "1"
